...
export default function OurProduct() {
  ...
  return (
    <div className="container mx-auto px-4 pb-20">
      <h1 className="text-3xl text-center font-semibold text-[#1C1B1F] tracking-tight  mb-8 pt-10">
        {" "}
        Our Products
      </h1>

      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4 px-0 md:px-20">
